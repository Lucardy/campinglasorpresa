...
('grupos', 'Reservas especiales para grupos grandes');
...
-- Crear tabla de precios de camping
CREATE TABLE IF NOT EXISTS precios_camping (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- Insertar precios iniciales de camping
INSERT INTO precios_camping (tipo, precio) VALUES
('base', 5000.00),
('adulto', 3000.00),
('menor', 1500.00);