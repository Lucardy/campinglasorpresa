...
class ClienteService {
    ...
    public function crearCliente($data) {
        ...
        $requiredFields = ['apellido', 'nombre', 'documento', 'telefono'];
        ...
        // Validar teléfono si se proporciona (formato básico)
    ...
    public function actualizarCliente($id, $data) {
        ...
        if (isset($data['telefono']) && !empty($data['telefono']) && !preg_match('/^[\d\s\-\+\(\)]+$/', $data['telefono'])) {
            throw new Exception('El formato del teléfono no es válido');
        }
