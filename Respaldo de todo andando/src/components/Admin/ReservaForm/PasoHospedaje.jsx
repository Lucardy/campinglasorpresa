...
const PasoHospedaje = ({
    ...
    const handleNext = () => {
        if (!formData.hospedaje_id && tipoHospedajeNombre?.toLowerCase() !== 'camping') {
            return;
        }
        onNext();
    };
        ...
        <div className="paso-hospedaje">
            ...
            <div className="form-group">
                ...
                >
                    ...
                    {Array.isArray(tiposHospedaje) && tiposHospedaje.map((tipo) => (
            ...
            <div className="form-actions">
                ...
                <button
                    ...
                    className="btn-next"
                    onClick={handleNext}
                    disabled={!formData.hospedaje_id && tipoHospedajeNombre?.toLowerCase() !== 'camping'}
                >
                    Siguiente
                </button>
            </div>
