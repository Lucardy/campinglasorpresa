...
import { FaSwimmingPool, FaDog, FaCar, FaWifi, FaFire, FaUtensils, FaFutbol, FaChild, FaDumbbell, FaMountain, FaPlug, FaBed, FaTv, FaFan, FaCheckCircle, FaTableTennis, FaPlay } from 'react-icons/fa';
...
import videoCabanas from '../assets/videos/videocabañas.mp4';
import './Cabanas.css';
      ...
      <div className="video-section">
        <div className="video-container">
          ...
          <div className="video-wrapper">
            <video 
              className="cabanas-video" 
              controls 
              preload="metadata"
              poster={img21}
            >
              <source src={videoCabanas} type="video/mp4" />
              Tu navegador no soporta el elemento de video.
            </video>
          </div>
          <p className="video-description">
            Descubre el confort y la comodidad de nuestras cabañas, 
            perfectas para disfrutar de una estadía inolvidable en contacto con la naturaleza.
          </p>
        </div>
      </div>
